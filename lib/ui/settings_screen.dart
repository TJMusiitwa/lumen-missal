    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          items: const [
            DropdownMenuItem(value: 'web', child: Text('World English Bible (WEB)')),
            DropdownMenuItem(value: 'kjv', child: Text('King James Version (KJV)')),
            DropdownMenuItem(value: 'bbe', child: Text('Bible in Basic English (BBE)')),
            DropdownMenuItem(value: 'oeb-us', child: Text('Open English Bible (US)')),
            DropdownMenuItem(value: 'clementine', child: Text('Clementine Latin Vulgate')),
            DropdownMenuItem(value: 'almeida', child: Text('João Ferreira de Almeida')),
            DropdownMenuItem(value: 'rccv', child: Text('Romanian Corrected Cornilescu')),
          ],
          onChanged: (value) {
            if (value != null) {
